...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            ...
            <h3>欢迎注册 H+</h3>
            <p>创建一个H+新账户</p>
            <form class="m-t" role="form" action="<%=path %>/user/addEntity" method="post">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="userId" placeholder="请再次输入密码" required="">
                </div>
                ...
                <p class="text-muted text-center"><small>已经有账户了？</small><a href="<%=path %>/login">点此登录</a>
                </p>

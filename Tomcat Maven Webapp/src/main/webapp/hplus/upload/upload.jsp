...
<body>
	<div>
		1.Spring mvc 上传相关配置文件
	</div>
	 <h1>springMVC字节流输入上传文件</h1>   
    <form name="userForm1" action="<%=path %>/Upload/upload1" enctype="multipart/form-data" method="post">  
        <div id="newUpload1">  
            <input type="file" name="file">  
        </div>  
           <input type="text" name="t" value="增加一行" >  
    ...
    <h1>springMVC下载</h1>   
    <form name="userForm3" action="<%=path %>/Upload/download"  method="post">  

...
<!--                             <span><img alt="image" class="img-circle" src="<%=path %>/hplus/img/profile_small.jpg" /></span> -->
...
<!--                                     <div class="dropdown-messages-box"> -->
<!--                                         <a href="profile.html" class="pull-left"> -->
<!--                                             <img alt="image" class="img-circle" src="<%=path %>/hplus/img/a4.jpg"> -->
<!--                                         </a> -->
<!--                                         <div class="media-body "> -->
...
<!--                                 <a href="#"> -->
<!--                                     <div class="pull-left text-center"> -->
<!--                                         <img alt="image" class="img-circle message-avatar" src="<%=path %>/hplus/img/a2.jpg"> -->
<!--                                     </div> -->
<!--                                     <div class="media-body"> -->
...
<!--                                 <a href="#"> -->
<!--                                     <div class="pull-left text-center"> -->
<!--                                         <img alt="image" class="img-circle message-avatar" src="<%=path %>/hplus/img/a3.jpg"> -->
...
<!--                                 <a href="#"> -->
<!--                                     <div class="pull-left text-center"> -->
<!--                                         <img alt="image" class="img-circle message-avatar" src="<%=path %>/hplus/img/a4.jpg"> -->
<!--                                     </div> -->
...
<!--                                 <a href="#"> -->
<!--                                     <div class="pull-left text-center"> -->
<!--                                         <img alt="image" class="img-circle message-avatar" src="<%=path %>/hplus/img/a8.jpg"> -->
<!--                                     </div> -->
<!--                                     <div class="media-body"> -->
...
<!--                                 <a href="#"> -->
<!--                                     <div class="pull-left text-center"> -->
<!--                                         <img alt="image" class="img-circle message-avatar" src="<%=path %>/hplus/img/a7.jpg"> -->
<!--                                     </div> -->
<!--                                     <div class="media-body"> -->
